...
x <- list(design_nr=1, N = 57, r = 32, s = 34, eff= "34/57 (59.6%)", CI_low= 50.29, CI_high=68.47,
          ...
          pi_param = 0.8)
expect_equivalent(
  current = as.list(sargent1stage(p0=0.5,pa=0.65,alpha=0.1,beta=0.1,eta=0.8,pi=0.8,eps = 0.005,N_min=0,N_max=100, rcpp=FALSE)),
  target = x)

expect_equivalent(
  current = as.list(sargent1stage(p0=0.5,pa=0.65,alpha=0.1,beta=0.1,eta=0.8,pi=0.8,eps = 0.005,N_min=0,N_max=100, rcpp=TRUE)),
  target = x)
