...
#' @export
#' @examples
#' result_H0 <-fleming2stage(p0 = 0.3, pa = 0.5, alpha = 0.1, beta = 0.1, eps = 0, N_min = 1,
#' N_max = 50, opt_under="H0")
#' result_Ha <-fleming2stage(p0 = 0.3, pa = 0.5, alpha = 0.1, beta = 0.1, eps = 0, N_min = 1,
...
fleming2stage.default <- function(p0, pa, alpha, beta, eps = 0, N_min, N_max, int=0, int_window=0.025, opt_under="H0") {
  ...
  if (int>0){
    if (upt_under=="H0"){res$EN_opt  <- "EN.p0_optimal"}
    if (upt_under=="Ha"){res$EN_opt  <- "EN.pa_optimal"}
